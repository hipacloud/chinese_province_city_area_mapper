...
def test_init_data():
    ...
    assert matcher._get("上海")[1][0] is ad_2_addr_dict["310100"]


def assert_addr(addr_df: pd.DataFrame, pos_sensitive=False):
    _assert_line(addr_df, pos_sensitive, 0, '上海', '上海市', '徐汇区', '虹漕路461号58号楼5楼', "310104", -1, -1, 0)
    ...
    _assert_line(addr_df, pos_sensitive, 3, '天津', '天津市', None, '', '120100', -1, 0, -1)
    ...
    _assert_line(addr_df, pos_sensitive, 6, "上海", "上海市", "浦东新区", "东明路街道三林路15号", "310115", -1, 0, 3)
    ...
    _assert_line(addr_df, pos_sensitive, 18, "海南省", "五指山市", None, "", "469001", 0, 2, -1)
    _assert_line(addr_df, pos_sensitive, 19, "新疆维吾尔自治区", "石河子市", None, "", "659001", 0, 2, -1)
    _assert_line(addr_df, pos_sensitive, 20, None, None, None, None, None, -1, -1, -1)
...
def test_umap():
    ...
    _assert_line(transed, False, 0, "北京", "北京市", "朝阳区", "汉庭酒店大山子店", "110105", -1, -1, 0)
...
#     _assert_line(addr_df, True, 1, "北京", "北京市", "朝阳区", "", "110105", 14, -1, 17)
#
